...
@FxNames({"ENDS", "ENDSWITH"})
public abstract class EndsWith extends Function {
    
    protected EndsWith(String name, String namespace, Class<?> argtype) {
    ...
    public static class CharImpl extends EndsWith {
        ...
        public Object evaluate(Environment context, Object... arguments) {
            ...
            Character suffix = safeArgumentOf(arguments, 1);
            return string.endsWith(suffix.toString());
        }
        
    }
    
    public static class StringImpl extends EndsWith {
        ...
        public Object evaluate(Environment context, Object... arguments) {
            String string = safeArgumentOf(arguments, 0);
            String suffix = safeArgumentOf(arguments, 1);
