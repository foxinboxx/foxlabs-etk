...
@FxNames({"TOSTRING", "TOSTR", "STRING", "STR"})
public class ToString extends Function {
    
    public ToString(String name, String namespace) {
        super(name, namespace, String.class, Object.class);
    }
    ...
    public Object evaluate(Environment context, Object... arguments) {
        return arguments[0] == null ? "" : arguments[0].toString();
    }
