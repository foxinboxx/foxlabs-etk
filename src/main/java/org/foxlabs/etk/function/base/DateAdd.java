...
public class DateAdd extends Function {
    ...
    public DateAdd(String name, String namespace) {
        super(name, namespace, java.util.Date.class, java.util.Date.class, Long.class);
    }
    ...
    public Object evaluate(Environment context, Object... arguments) {
        ...
        Long delta = safeArgumentOf(arguments, 1);
        return new java.util.Date(date.getTime() + delta);
    }
