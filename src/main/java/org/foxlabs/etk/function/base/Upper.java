...
@FxNames({"UPPER", "UPPERCASE", "TOUPPER", "TOUPPERCASE"})
public abstract class Upper extends Function {
    
    protected Upper(String name, String namespace, Class<?> type) {
    ...
    public static class CharImpl extends Upper {
    ...
    public static class StringImpl extends Upper {
