...
public class Atan2 extends Function {
    ...
    public Atan2(String name, String namespace) {
        super(name, namespace, Double.class, Double.class, Double.class);
    }
    ...
    public Object evaluate(Environment context, Object... arguments) {
        Double y = safeArgumentOf(arguments, 0);
        Double x = safeArgumentOf(arguments, 1);
