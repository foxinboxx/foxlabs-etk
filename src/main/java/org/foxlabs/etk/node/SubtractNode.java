...
public final class SubtractNode extends BinaryNode implements ArithmeticalNode {
    
    private final Calculator calculator;
    
    SubtractNode(Calculator calculator, Node operand1, Node operand2) {
    ...
    public Number evaluate(Environment context) throws EvaluationException {
        ...
        try {
            return calculator.subtract(obj1, obj2);
        } catch (Exception e) {
