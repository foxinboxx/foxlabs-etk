...
public final class GreaterThanEqualNode extends BinaryNode implements RelationalNode {
    
    private final Comparator comparator;
    
    GreaterThanEqualNode(Comparator comparator, Node operand1, Node operand2) {
